...
void main() {
  testWidgets('Should transfer to a contact', (tester) async {
    ...
    final maria = Contact(0, 'Maria Lisboa', 1000);
    when(mockContactDao.findAll()).thenAnswer((invocation) async => [maria]);
    ...
    final contactItem = find.byWidgetPredicate((widget) {
      if (widget is ContactItem) {
        return widget.contact.name == 'Maria Lisboa' &&
    ...
    final contactName = find.text('Maria Lisboa');
    ...
    when(mockTransactionWebClient.save(Transaction(null, 200, maria), '1000'))
        .thenAnswer((_) async => Transaction(null, 200, maria));
